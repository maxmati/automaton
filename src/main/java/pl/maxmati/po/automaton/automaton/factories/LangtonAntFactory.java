...
import pl.maxmati.po.automaton.automaton.LangtonAnt;
 ...
 */
public class LangtonAntFactory extends AutomatonFactory {
    final Map<String, Object> defaultParams = new LinkedHashMap<>();

    public LangtonAntFactory() {
    ...
    protected Automaton newAutomaton(Map<String, Object> params) {
        return new LangtonAnt( (Integer) params.get("Width"), (Integer) params.get("Height"), (Boolean) params.get("Wrap"));
    }
}
